...
public class EmailWithAttachmentUtility {
	...
	public static void SendEmail(String sub, String msg, String scrshotPath1, String scrshotPath2, String scrshotPath3, String scrshotPath4, String description)
		...
		attachment.setPath(scrshotPath1);
		...
		attachment.setPath(scrshotPath2);
		attachment.setDisposition(EmailAttachment.ATTACHMENT);
		attachment.setDescription(description);
		attachment.setName("Chetan Kanani");
		// add the attachment
		...
		attachment = new EmailAttachment();
		attachment.setPath(scrshotPath3);
		attachment.setDisposition(EmailAttachment.ATTACHMENT);
		attachment.setDescription(description);
		attachment.setName("Chetan Kanani");
		// add the attachment
		...
		attachment = new EmailAttachment();
		attachment.setPath(scrshotPath4);
		attachment.setDisposition(EmailAttachment.ATTACHMENT);
		attachment.setDescription(description);
		attachment.setName("Chetan Kanani");
		// add the attachment
